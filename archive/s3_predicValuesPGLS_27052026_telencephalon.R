...
write_csv(cor_pearson, "tables/correlation_rCMRGlc_prediction_error_by_telencephalon_group_pearson.csv")
write_csv(cor_spearman, "tables/correlation_rCMRGlc_prediction_error_by_telencephalon_group_spearman.csv")
