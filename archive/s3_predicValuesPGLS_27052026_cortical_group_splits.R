...
ggsave("figs/plot_prediction_BM_vs_pagel.png", p1, width = 10, height = 7, dpi = 300)
ggsave("figs/plot_standardized_prediction_error.png", p2, width = 10, height = 7, dpi = 300)
ggsave("figs/plot_human_brain_mosaicism.png", p3, width = 12, height = 8, dpi = 300)
ggsave("figs/plot_pagel_lambda_profile.png", p4, width = 12, height = 9, dpi = 300)
...
ggsave("figs/plot_human_brain_mosaicism.pdf", p3, width = 12, height = 8)
ggsave("figs/plot_pagel_lambda_profile.pdf", p4, width = 12, height = 9)
