...
# Inspect the distribution of dissections and their original anatomical labels
unique(obs$ROIGroupFine)
unique(obs$ROIGroupCoarse)
...
anatomy_rules <- tribble(
  ...
  "Hippocampal CA|Dentate gyrus|Hippocampus",
  "Hippocampus",
