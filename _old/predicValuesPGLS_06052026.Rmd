...
heiss_stephan_tbl <- read_csv("data/Heiss_Stephan_data.csv")
...
ggsave("plot1_prediction_BM_vs_pagel.pdf", p1, width = 10, height = 7)
ggsave("plot2_standardized_prediction_error.pdf", p2, width = 10, height = 7)
ggsave("plot3_human_brain_mosaicism.pdf", p3, width = 10, height = 7)
ggsave("plot4_pagel_lambda_profile.pdf", p4, width = 10, height = 7)
...
write_xlsx(print_ready_df, here("tables", "Table 4 Predicted volumes for Brownian and Pagel's lambda models.xlsx"), col_names = FALSE)
