...
p_overlay_no_msn <- make_overlay_plot(
  ...
  broad_caption = paste(
    ...
    "The plotted x-axis is the raw, unlogged E:I ratio."
  ),
...
p_overlay_with_msn <- make_overlay_plot(
  ...
  plot_subtitle = "X-axis is raw E:I, not log2-transformed. \nGrey denominator includes inhibitory interneuron plus MSN projection classes; \nblue Jorstad points are unchanged.",
  # broad_caption = paste(
