...
if (!dir.exists("figs/s6")) dir.create("figs/s6", recursive = TRUE)
...
ggsave(
  filename = "figs/s6/sv2a_vs_rcmrglc.pdf",
  plot     = p1,
  width    = 9,
  height   = 6.5,
  units    = "in",
...
ggsave(
  filename = "figs/s6/sv2a_vs_rcmrglc.jpg",
  plot     = p1,
  width    = 9,
  height   = 6.5,
  units    = "in",
...
ggsave(
  filename = "figs/s6/sv2a_vs_rcmrglc_labelled.pdf",
  plot     = p2,
  width    = 10,
  height   = 7,
  units    = "in",
...
ggsave(
  filename = "figs/s6/sv2a_vs_rcmrglc_labelled.jpg",
  plot     = p2,
  width    = 10,
  height   = 7,
  units    = "in",
...
plot_df %>%
  ...
  write.csv("tables/s6_sv2a_rcmrglc_matched_regions.csv", row.names = FALSE)

message("Study 6 done. Figures in figs/s6/, merged table in tables/.")
