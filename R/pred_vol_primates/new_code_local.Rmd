...
##########
## ------------------------------------------------------------------
## REFACTORED: removes redundant per-structure prep + model-fitting code
## Drop-in replacement for everything from:
##   "# --- Helper function to transform VCV by Lambda"
## onward (you can delete your predict_human_one_var() + Plot III/IV loops)
## ------------------------------------------------------------------
