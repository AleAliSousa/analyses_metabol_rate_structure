...
heiss <- read.csv("raw/Heiss_etal_2004_TABLE1.csv", stringsAsFactors = FALSE, check.names = FALSE)
...
# -----------------------------
# 6. Save intermediate final table
# -----------------------------

write.csv(
  order_table,
  "data/Heiss_Stephan_data.csv",
  row.names = FALSE,
  na = ""
)
...
saveWorkbook(wb, "tables/Table 1 Regional cerebral metabolic rates corresponding volume terms and data sources.xlsx", overwrite = TRUE)